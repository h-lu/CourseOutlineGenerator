                ...
                "og": [
                    {
                        ...
                        "criteria": [
                            "优秀(90-100分)：能够准确理解并灵活运用概念和原理，能够举一反三",
                            "良好(80-89分)：能够正确理解并应用概念和原理，有一定延伸能力",
                            "中等(70-79分)：基本理解概念和原理，能够进行简单应用",
                            "及格(60-69分)：对概念和原理理解有限，应用能力较弱"
                        ],
                        "mapping": {
